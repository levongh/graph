...
/**
 * @file fiducciamattheyses.h
 * @title declaration of FiducciaMattheyses class
 ...
 */
class FiducciaMattheyses : public GraphPartition
{
public:
    FiducciaMattheyses(Graph* G, PartitionConfig config = PartitionConfig())
